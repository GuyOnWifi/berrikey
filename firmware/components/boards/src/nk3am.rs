...
pub fn init_pins(gpiote: GPIOTE, p0: P0, p1: P1) -> BoardGPIO {
    ...
    /* touch sensor */
    let touch = gpio_p0.p0_02.into_push_pull_output(Level::High).degrade();
    ...
    let se_scl = gpio_p1.p1_09.into_floating_input().degrade();
    let se_sda = gpio_p0.p0_12.into_floating_input().degrade();
    ...
    let flash_spi_cs = gpio_p1.p1_15.into_push_pull_output(Level::High).degrade();
    let flash_spi_clk = gpio_p0.p0_31.into_push_pull_output(Level::Low).degrade();
    let flash_spi_mosi = gpio_p0.p0_29.into_push_pull_output(Level::Low).degrade();
    let flash_spi_miso = gpio_p1.p1_13.into_floating_input().degrade();
